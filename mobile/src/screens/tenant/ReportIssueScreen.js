...
const styles = StyleSheet.create({
  ...
  textArea: {
    ...
    color: colors.ink, backgroundColor: colors.surface, textAlignVertical: 'top', minHeight: 110,
  },
  photoButton: {
    borderWidth: 1.5, borderColor: colors.border, borderStyle: 'dashed', borderRadius: 10,
    padding: 24, alignItems: 'center', marginTop: spacing.xs,
  },
  photoButtonText: { fontFamily: 'Manrope_600SemiBold', fontSize: 14, color: colors.inkMuted },
  photoPreview: { width: '100%', height: 180, borderRadius: 10, marginTop: spacing.xs },
  button: {
